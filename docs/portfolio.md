...
Explore highlights from my work in technical writing, documentation systems, and knowledge management. Each project reflects a commitment to clarity, collaboration, and creating tools that make information effortless to find and use.
...
<h3> &#128206; [Big Fish SDKs](./portfolio-ref-bfg.md) (iOS, Android, Unity)</h3>
<h3> &#128206; [High Fidelity API Reference](./portfolio-ref-hifi.md) (JavaScript)</h3>
<h3> &#128206; [Tutorial: How to Create a Portal](./portfolio-tutorial-hifi.md) (JavaScript)</h3>
...
Release notes bridge the gap between development and delivery, helping users understand what’s new, what’s fixed, and what’s improved in each version. I’ve written release notes for SDKs, APIs, and software products, working closely with engineers to identify key updates, clarify technical changes, and highlight their impact. 

<h3> [Beta Release](./portfolio-release-hifi.md)</h3>
<h3> [BFG SDK Release Notes](./portfolio-release-bfg.md)</h3>
...
<!--
    ...
    - **[The Anchor: Your gateway into Big Fish's documentation](./portfolio-help-bfg.md)** _(Coming Soon)_
